...
@section('content')
	<div class="mws-panel grid_8">
		<div class="mws-panel-header">
	    	<span style="float: left;"><i class="icon-table"></i>商品规格</span>
	    	<button type="button" class="btn btn-success" style="float:right;">新增规格</button>
	    </div>
	    <script type="text/javascript">
	    	var btn = document.getElementsByClassName('btn-success');
	    	// btn返回的是一个数组对象，不能直接操作
	    	btn[0].onclick = function(){
	    		window.location.href = '/admin/product/quali/add';
	    	}
	    </script>
	    <div class="mws-panel-body no-padding">
	        ...
	        <tbody role="alert" aria-live="polite" aria-relevant="all">
	            ...
	            <tr class="odd">
	                ...
	                <td class=" ">{{ $v['pname'] }}</td>
	                <td class=" ">
	                	<a href="/admin/product/quali/delete/{{ $v['id'] }}" style="color: black;font-size: 19px;padding-left: 20px;"><i class="icon-trash"></i></a>
	                	<a href="/admin/product/quali/add/{{ $v['id'] }}" style="color: black;font-size: 19px;padding-left: 20px;"><i class="icon-plus"></i></a>
	                </td>
	            </tr>
	            @endforeach
	                </tbody></table>
