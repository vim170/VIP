                    ...
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item">
                            <select class="small" name="position">
                                ...
                                <option value="1" @if($data['position']==1) selected @endif>首页头部广告</option>
                                <option value="2" @if($data['position']==2) selected @endif>首页公告栏广告</option>
                                <option value="3" @if($data['position']==3) selected @endif>所有页面尾部显示</option>
                                <option value="4" @if($data['position']==4) selected @endif>所有页面头部显示</option>
                                <option value="5" @if($data['position']==5) selected @endif>焦点图位置显示</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item clearfix">
                            <ul class="mws-form-list inline">
                                <li><input type="radio" name="enabled" value="1" @if($data['enabled']==1) checked @endif> <label>启用</label></li>
                                <li><input type="radio" name="enabled" value="2" @if($data['enabled']==2) checked @endif> <label>禁用</label></li>
                            </ul>
                        </div>
                    </div>
                </div>
